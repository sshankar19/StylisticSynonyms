...
# Step 2: Ask for input over and over:

while input("Do you want to find synonyms?").lower() != "no":

    style = input("Enter your document thus far:")
    word_to_find = input("Enter the word that you want to find a synonym for:")
    word_usage = input("Enter a small sentence demonstrating usage of the word")
    ...
    syns = find_syns(word_to_find, tag)
